...
defaultproperties
{
     ...
     FavorIcon=(WidgetTexture=Texture'OLGhostMaster.Icons.favor',RenderStyle=STY_Alpha,TextureCoords=(X1=0,Y1=0,X2=128,Y2=128),TextureScale=0.220000,OffsetX=8,OffsetY=140,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
